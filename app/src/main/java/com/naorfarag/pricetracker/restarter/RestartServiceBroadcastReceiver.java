package com.naorfarag.pricetracker.restarter;
...
import com.naorfarag.pricetracker.ProcessMainClass;
...
public class RestartServiceBroadcastReceiver extends BroadcastReceiver {
    ...
    public static void scheduleJob(Context context) {
        Log.d("scheduleJob", "SCHEDUELING JOB!");
    ...
    private void registerRestarterReceiver(final Context context) {
        ...
        new Handler().postDelayed(() -> {
            ...
            filter.addAction(Finals.RESTART_INTENT);
            try {
